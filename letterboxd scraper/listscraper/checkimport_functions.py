...
def checkimport_outputname(output_name, global_output_name, output_file_extension, listname, username, url_total, url_count, concat):
    """ 
    ...
    if concat and global_output_name:
        ...
        if output_name == None:
            check = True
            name = listname + "-" + username + output_file_extension
