...
class List:
    ...
    def __init__(self, list_url, pagestring, output_name, global_output_name, output_file_extension, url_total, url_count, concat):
        ...
        outputnamecheck, self.output_name = cef.checkimport_outputname(output_name, global_output_name, self.output_file_extension, self.listname, self.username, url_total, url_count, concat)
